...
public class ApplicationCacheResponseDetails {
  ...
  public ApplicationCacheResponseDetails id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public ApplicationCacheResponseDetails name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicationCacheResponseDetails browserCacheSettings(@javax.annotation.Nonnull String browserCacheSettings) {
  ...
  public ApplicationCacheResponseDetails browserCacheSettingsMaximumTtl(@javax.annotation.Nonnull Long browserCacheSettingsMaximumTtl) {
  ...
  public ApplicationCacheResponseDetails cdnCacheSettings(@javax.annotation.Nonnull String cdnCacheSettings) {
  ...
  public ApplicationCacheResponseDetails cdnCacheSettingsMaximumTtl(@javax.annotation.Nonnull Long cdnCacheSettingsMaximumTtl) {
  ...
  public ApplicationCacheResponseDetails cacheByQueryString(@javax.annotation.Nonnull String cacheByQueryString) {
  ...
  public ApplicationCacheResponseDetails queryStringFields(@javax.annotation.Nullable List<String> queryStringFields) {
  ...
  public ApplicationCacheResponseDetails enableQueryStringSort(@javax.annotation.Nonnull Boolean enableQueryStringSort) {
  ...
  public ApplicationCacheResponseDetails cacheByCookies(@javax.annotation.Nonnull String cacheByCookies) {
  ...
  public ApplicationCacheResponseDetails cookieNames(@javax.annotation.Nullable List<String> cookieNames) {
  ...
  public ApplicationCacheResponseDetails adaptiveDeliveryAction(@javax.annotation.Nullable String adaptiveDeliveryAction) {
  ...
  public ApplicationCacheResponseDetails deviceGroup(@javax.annotation.Nullable List<Integer> deviceGroup) {
  ...
  public void setDeviceGroup(@javax.annotation.Nullable List<Integer> deviceGroup) {
    this.deviceGroup = deviceGroup;
  }


  public ApplicationCacheResponseDetails enableCachingForPost(@javax.annotation.Nonnull Boolean enableCachingForPost) {
  ...
  public ApplicationCacheResponseDetails enableCachingForOptions(@javax.annotation.Nullable Boolean enableCachingForOptions) {
  ...
  public ApplicationCacheResponseDetails l2CachingEnabled(@javax.annotation.Nonnull Boolean l2CachingEnabled) {
  ...
  public ApplicationCacheResponseDetails isSliceConfigurationEnabled(@javax.annotation.Nullable Boolean isSliceConfigurationEnabled) {
  ...
  public ApplicationCacheResponseDetails isSliceEdgeCachingEnabled(@javax.annotation.Nullable Boolean isSliceEdgeCachingEnabled) {
  ...
  public ApplicationCacheResponseDetails isSliceL2CachingEnabled(@javax.annotation.Nullable Boolean isSliceL2CachingEnabled) {
  ...
  public ApplicationCacheResponseDetails sliceConfigurationRange(@javax.annotation.Nullable Long sliceConfigurationRange) {
  ...
  public ApplicationCacheResponseDetails enableStaleCache(@javax.annotation.Nullable Boolean enableStaleCache) {
  ...
  public ApplicationCacheResponseDetails l2Region(@javax.annotation.Nullable String l2Region) {
