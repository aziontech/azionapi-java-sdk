...
public class ApplicationCreateInstanceRequestArgs extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ApplicationCreateInstanceRequestArgs.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ApplicationCreateInstanceRequestArgs.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ApplicationCreateInstanceRequestArgs' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ApplicationCreateInstanceRequestArgs>() {
                @Override
                public void write(JsonWriter out, ApplicationCreateInstanceRequestArgs value) throws IOException {
                ...
                @Override
                public ApplicationCreateInstanceRequestArgs read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ApplicationCreateInstanceRequestArgs ret = new ApplicationCreateInstanceRequestArgs();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ApplicationCreateInstanceRequestArgs: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ApplicationCreateInstanceRequestArgs() {
        super("oneOf", Boolean.FALSE);
    }

    public ApplicationCreateInstanceRequestArgs(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ApplicationCreateInstanceRequestArgs.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ApplicationCreateInstanceRequestArgs
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ApplicationCreateInstanceRequestArgs with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ApplicationCreateInstanceRequestArgs given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ApplicationCreateInstanceRequestArgs
     * @throws IOException if the JSON string is invalid with respect to ApplicationCreateInstanceRequestArgs
     */
    public static ApplicationCreateInstanceRequestArgs fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ApplicationCreateInstanceRequestArgs.class);
    }

    /**
     * Convert an instance of ApplicationCreateInstanceRequestArgs to an JSON string
     *
     * @return JSON string
     */
