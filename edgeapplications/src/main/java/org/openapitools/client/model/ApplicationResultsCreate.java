...
public class ApplicationResultsCreate {
  ...
  public ApplicationResultsCreate id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public ApplicationResultsCreate name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicationResultsCreate active(@javax.annotation.Nonnull Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ApplicationResultsCreate debugRules(@javax.annotation.Nonnull Boolean debugRules) {
  ...
  public ApplicationResultsCreate http3(@javax.annotation.Nonnull Boolean http3) {
    this.http3 = http3;
    return this;
  }
  ...
  public ApplicationResultsCreate supportedCiphers(@javax.annotation.Nonnull String supportedCiphers) {
  ...
  public ApplicationResultsCreate deliveryProtocol(@javax.annotation.Nonnull String deliveryProtocol) {
  ...
  public ApplicationResultsCreate httpPort(@javax.annotation.Nullable Object httpPort) {
  ...
  public ApplicationResultsCreate httpsPort(@javax.annotation.Nullable Object httpsPort) {
  ...
  public ApplicationResultsCreate minimumTlsVersion(@javax.annotation.Nonnull String minimumTlsVersion) {
  ...
  public ApplicationResultsCreate applicationAcceleration(@javax.annotation.Nonnull Boolean applicationAcceleration) {
  ...
  public ApplicationResultsCreate caching(@javax.annotation.Nonnull Boolean caching) {
  ...
  public ApplicationResultsCreate deviceDetection(@javax.annotation.Nonnull Boolean deviceDetection) {
  ...
  public ApplicationResultsCreate edgeFirewall(@javax.annotation.Nonnull Boolean edgeFirewall) {
  ...
  public ApplicationResultsCreate edgeFunctions(@javax.annotation.Nonnull Boolean edgeFunctions) {
  ...
  public ApplicationResultsCreate imageOptimization(@javax.annotation.Nonnull Boolean imageOptimization) {
  ...
  public ApplicationResultsCreate loadBalancer(@javax.annotation.Nonnull Boolean loadBalancer) {
  ...
  public ApplicationResultsCreate rawLogs(@javax.annotation.Nonnull Boolean rawLogs) {
  ...
  public ApplicationResultsCreate webApplicationFirewall(@javax.annotation.Nonnull Boolean webApplicationFirewall) {
  ...
  public ApplicationResultsCreate l2Caching(@javax.annotation.Nullable Boolean l2Caching) {
  ...
  public ApplicationResultsCreate websocket(@javax.annotation.Nullable Boolean websocket) {
