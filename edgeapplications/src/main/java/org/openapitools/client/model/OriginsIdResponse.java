...
public class OriginsIdResponse {
  ...
  public OriginsIdResponse results(@javax.annotation.Nonnull OriginsResultResponse results) {
  ...
  public void setResults(@javax.annotation.Nonnull OriginsResultResponse results) {
    this.results = results;
  }


  public OriginsIdResponse schemaVersion(@javax.annotation.Nonnull Long schemaVersion) {
