...
public class ApplicationCachePutRequest {
  ...
  public ApplicationCachePutRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicationCachePutRequest browserCacheSettings(@javax.annotation.Nullable String browserCacheSettings) {
  ...
  public ApplicationCachePutRequest browserCacheSettingsMaximumTtl(@javax.annotation.Nullable Long browserCacheSettingsMaximumTtl) {
  ...
  public ApplicationCachePutRequest cdnCacheSettings(@javax.annotation.Nullable String cdnCacheSettings) {
  ...
  public ApplicationCachePutRequest cdnCacheSettingsMaximumTtl(@javax.annotation.Nullable Long cdnCacheSettingsMaximumTtl) {
  ...
  public ApplicationCachePutRequest cacheByQueryString(@javax.annotation.Nullable String cacheByQueryString) {
  ...
  public ApplicationCachePutRequest queryStringFields(@javax.annotation.Nullable List<String> queryStringFields) {
  ...
  public ApplicationCachePutRequest enableQueryStringSort(@javax.annotation.Nullable Boolean enableQueryStringSort) {
  ...
  public ApplicationCachePutRequest cacheByCookies(@javax.annotation.Nullable String cacheByCookies) {
  ...
  public ApplicationCachePutRequest cookieNames(@javax.annotation.Nullable List<String> cookieNames) {
  ...
  public ApplicationCachePutRequest adaptiveDeliveryAction(@javax.annotation.Nullable String adaptiveDeliveryAction) {
  ...
  public ApplicationCachePutRequest deviceGroup(@javax.annotation.Nullable List<Integer> deviceGroup) {
  ...
  public ApplicationCachePutRequest enableCachingForPost(@javax.annotation.Nullable Boolean enableCachingForPost) {
  ...
  public ApplicationCachePutRequest l2CachingEnabled(@javax.annotation.Nullable Boolean l2CachingEnabled) {
  ...
  public ApplicationCachePutRequest isSliceConfigurationEnabled(@javax.annotation.Nullable Boolean isSliceConfigurationEnabled) {
  ...
  public ApplicationCachePutRequest isSliceEdgeCachingEnabled(@javax.annotation.Nullable Boolean isSliceEdgeCachingEnabled) {
  ...
  public ApplicationCachePutRequest isSliceL2CachingEnabled(@javax.annotation.Nullable Boolean isSliceL2CachingEnabled) {
  ...
  public ApplicationCachePutRequest sliceConfigurationRange(@javax.annotation.Nullable Long sliceConfigurationRange) {
  ...
  public ApplicationCachePutRequest enableCachingForOptions(@javax.annotation.Nullable Boolean enableCachingForOptions) {
  ...
  public ApplicationCachePutRequest enableStaleCache(@javax.annotation.Nullable Boolean enableStaleCache) {
  ...
  public ApplicationCachePutRequest l2Region(@javax.annotation.Nullable String l2Region) {
