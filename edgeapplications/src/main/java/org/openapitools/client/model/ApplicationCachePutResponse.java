...
public class ApplicationCachePutResponse {
  ...
  public ApplicationCachePutResponse results(@javax.annotation.Nonnull ApplicationCacheResponseDetails results) {
  ...
  public void setResults(@javax.annotation.Nonnull ApplicationCacheResponseDetails results) {
    this.results = results;
  }


  public ApplicationCachePutResponse schemaVersion(@javax.annotation.Nonnull Long schemaVersion) {
