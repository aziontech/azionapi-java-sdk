...
public class RulesEngineIdResponse {
  ...
  public RulesEngineIdResponse results(@javax.annotation.Nonnull RulesEngineResultResponse results) {
  ...
  public void setResults(@javax.annotation.Nonnull RulesEngineResultResponse results) {
    this.results = results;
  }


  public RulesEngineIdResponse schemaVersion(@javax.annotation.Nonnull Long schemaVersion) {
