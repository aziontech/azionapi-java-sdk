...
public class ApplicationCacheResults {
  ...
  public ApplicationCacheResults id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public ApplicationCacheResults name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicationCacheResults browserCacheSettings(@javax.annotation.Nonnull String browserCacheSettings) {
  ...
  public ApplicationCacheResults browserCacheSettingsMaximumTtl(@javax.annotation.Nonnull Long browserCacheSettingsMaximumTtl) {
  ...
  public ApplicationCacheResults cdnCacheSettings(@javax.annotation.Nonnull String cdnCacheSettings) {
  ...
  public ApplicationCacheResults cdnCacheSettingsMaximumTtl(@javax.annotation.Nonnull Long cdnCacheSettingsMaximumTtl) {
  ...
  public ApplicationCacheResults cacheByQueryString(@javax.annotation.Nonnull String cacheByQueryString) {
  ...
  public ApplicationCacheResults queryStringFields(@javax.annotation.Nullable List<String> queryStringFields) {
  ...
  public ApplicationCacheResults enableQueryStringSort(@javax.annotation.Nonnull Boolean enableQueryStringSort) {
  ...
  public ApplicationCacheResults cacheByCookies(@javax.annotation.Nonnull String cacheByCookies) {
  ...
  public ApplicationCacheResults cookieNames(@javax.annotation.Nullable List<String> cookieNames) {
  ...
  public ApplicationCacheResults adaptiveDeliveryAction(@javax.annotation.Nonnull String adaptiveDeliveryAction) {
  ...
  public ApplicationCacheResults deviceGroup(@javax.annotation.Nonnull List<Integer> deviceGroup) {
  ...
  public ApplicationCacheResults enableCachingForPost(@javax.annotation.Nonnull Boolean enableCachingForPost) {
  ...
  public ApplicationCacheResults l2CachingEnabled(@javax.annotation.Nonnull Boolean l2CachingEnabled) {
  ...
  public ApplicationCacheResults isSliceConfigurationEnabled(@javax.annotation.Nullable Boolean isSliceConfigurationEnabled) {
  ...
  public ApplicationCacheResults isSliceEdgeCachingEnabled(@javax.annotation.Nullable Boolean isSliceEdgeCachingEnabled) {
  ...
  public ApplicationCacheResults isSliceL2CachingEnabled(@javax.annotation.Nullable Boolean isSliceL2CachingEnabled) {
  ...
  public ApplicationCacheResults sliceConfigurationRange(@javax.annotation.Nullable Long sliceConfigurationRange) {
  ...
  public ApplicationCacheResults enableCachingForOptions(@javax.annotation.Nonnull Boolean enableCachingForOptions) {
  ...
  public void setEnableCachingForOptions(@javax.annotation.Nonnull Boolean enableCachingForOptions) {
    this.enableCachingForOptions = enableCachingForOptions;
  }


  public ApplicationCacheResults enableStaleCache(@javax.annotation.Nonnull Boolean enableStaleCache) {
  ...
  public void setEnableStaleCache(@javax.annotation.Nonnull Boolean enableStaleCache) {
    this.enableStaleCache = enableStaleCache;
  }


  public ApplicationCacheResults l2Region(@javax.annotation.Nullable String l2Region) {
