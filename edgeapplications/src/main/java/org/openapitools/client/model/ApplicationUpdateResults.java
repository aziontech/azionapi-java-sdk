...
public class ApplicationUpdateResults {
  ...
  public ApplicationUpdateResults id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public ApplicationUpdateResults name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicationUpdateResults deliveryProtocol(@javax.annotation.Nonnull String deliveryProtocol) {
  ...
  public ApplicationUpdateResults httpPort(@javax.annotation.Nullable Object httpPort) {
  ...
  public ApplicationUpdateResults httpsPort(@javax.annotation.Nullable Object httpsPort) {
  ...
  public ApplicationUpdateResults minimumTlsVersion(@javax.annotation.Nonnull String minimumTlsVersion) {
  ...
  public ApplicationUpdateResults active(@javax.annotation.Nonnull Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ApplicationUpdateResults debugRules(@javax.annotation.Nonnull Boolean debugRules) {
  ...
  public ApplicationUpdateResults http3(@javax.annotation.Nonnull Boolean http3) {
    this.http3 = http3;
    return this;
  }
  ...
  public ApplicationUpdateResults supportedCiphers(@javax.annotation.Nonnull String supportedCiphers) {
  ...
  public ApplicationUpdateResults applicationAcceleration(@javax.annotation.Nonnull Boolean applicationAcceleration) {
  ...
  public ApplicationUpdateResults caching(@javax.annotation.Nonnull Boolean caching) {
  ...
  public ApplicationUpdateResults deviceDetection(@javax.annotation.Nonnull Boolean deviceDetection) {
  ...
  public ApplicationUpdateResults edgeFirewall(@javax.annotation.Nonnull Boolean edgeFirewall) {
  ...
  public ApplicationUpdateResults edgeFunctions(@javax.annotation.Nonnull Boolean edgeFunctions) {
  ...
  public ApplicationUpdateResults imageOptimization(@javax.annotation.Nonnull Boolean imageOptimization) {
  ...
  public ApplicationUpdateResults l2Caching(@javax.annotation.Nonnull Boolean l2Caching) {
  ...
  public ApplicationUpdateResults loadBalancer(@javax.annotation.Nonnull Boolean loadBalancer) {
  ...
  public ApplicationUpdateResults rawLogs(@javax.annotation.Nonnull Boolean rawLogs) {
  ...
  public ApplicationUpdateResults webApplicationFirewall(@javax.annotation.Nonnull Boolean webApplicationFirewall) {
  ...
  public ApplicationUpdateResults websocket(@javax.annotation.Nullable Boolean websocket) {
