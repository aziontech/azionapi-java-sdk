...
public class CreateEdgeFunctionRequestJsonArgs extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateEdgeFunctionRequestJsonArgs.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateEdgeFunctionRequestJsonArgs.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateEdgeFunctionRequestJsonArgs' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateEdgeFunctionRequestJsonArgs>() {
                @Override
                public void write(JsonWriter out, CreateEdgeFunctionRequestJsonArgs value) throws IOException {
                ...
                @Override
                public CreateEdgeFunctionRequestJsonArgs read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateEdgeFunctionRequestJsonArgs ret = new CreateEdgeFunctionRequestJsonArgs();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateEdgeFunctionRequestJsonArgs: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateEdgeFunctionRequestJsonArgs() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateEdgeFunctionRequestJsonArgs(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CreateEdgeFunctionRequestJsonArgs.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateEdgeFunctionRequestJsonArgs
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for CreateEdgeFunctionRequestJsonArgs with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of CreateEdgeFunctionRequestJsonArgs given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreateEdgeFunctionRequestJsonArgs
     * @throws IOException if the JSON string is invalid with respect to CreateEdgeFunctionRequestJsonArgs
     */
    public static CreateEdgeFunctionRequestJsonArgs fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreateEdgeFunctionRequestJsonArgs.class);
    }

    /**
     * Convert an instance of CreateEdgeFunctionRequestJsonArgs to an JSON string
     *
     * @return JSON string
     */
